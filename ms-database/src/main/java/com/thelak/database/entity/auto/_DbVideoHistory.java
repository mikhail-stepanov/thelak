...
/**
 * Class _DbVideoHistory was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _DbVideoHistory extends CayenneDataObject {
    ...
    public static final Property<DbVideo> HISTORY_TO_VIDEO = Property.create("historyToVideo", DbVideo.class);
    ...
    public void setHistoryToVideo(DbVideo historyToVideo) {
        setToOneTarget("historyToVideo", historyToVideo, true);
    }

    public DbVideo getHistoryToVideo() {
        return (DbVideo)readProperty("historyToVideo");
    }
