...
/**
 * Class _DbVideoRating was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _DbVideoRating extends CayenneDataObject {
    ...
    public static final Property<DbVideo> RATING_TO_VIDEO = Property.create("ratingToVideo", DbVideo.class);
    ...
    public void setRatingToVideo(DbVideo ratingToVideo) {
        setToOneTarget("ratingToVideo", ratingToVideo, true);
    }

    public DbVideo getRatingToVideo() {
        return (DbVideo)readProperty("ratingToVideo");
    }
