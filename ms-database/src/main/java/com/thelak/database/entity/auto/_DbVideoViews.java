...
/**
 * Class _DbVideoViews was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _DbVideoViews extends CayenneDataObject {
    ...
    public static final Property<DbVideo> VIEW_TO_VIDEO = Property.create("viewToVideo", DbVideo.class);
    ...
    public void setViewToVideo(DbVideo viewToVideo) {
        setToOneTarget("viewToVideo", viewToVideo, true);
    }

    public DbVideo getViewToVideo() {
        return (DbVideo)readProperty("viewToVideo");
    }
