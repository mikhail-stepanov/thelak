...
public abstract class _DbVideo extends CayenneDataObject {
    ...
    public static final Property<List<DbVideoViews>> VIDEO_TO_VIEW = Property.create("videoToView", List.class);
    ...
    public void addToVideoToView(DbVideoViews obj) {
        addToManyTarget("videoToView", obj, true);
    }
    public void removeFromVideoToView(DbVideoViews obj) {
        removeToManyTarget("videoToView", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<DbVideoViews> getVideoToView() {
        return (List<DbVideoViews>)readProperty("videoToView");
    }
