...
public abstract class _DbArticle extends CayenneDataObject {
    ...
    public int getRating() {
        Object value = readProperty("rating");
    ...
    public void addToArticleToRating(DbArticleRating obj) {
        addToManyTarget("articleToRating", obj, true);
    }
    public void removeFromArticleToRating(DbArticleRating obj) {
        removeToManyTarget("articleToRating", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<DbArticleRating> getArticleToRating() {
        return (List<DbArticleRating>)readProperty("articleToRating");
    }


    public void addToArticleToView(DbArticleView obj) {
        addToManyTarget("articleToView", obj, true);
    }
    public void removeFromArticleToView(DbArticleView obj) {
        removeToManyTarget("articleToView", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<DbArticleView> getArticleToView() {
        return (List<DbArticleView>)readProperty("articleToView");
    }
